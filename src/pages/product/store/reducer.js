...
const defaultState = fromJS({
  products: [
    ...
    techDetail: [
      "Thickness: 5/8 (15.9 mm) Widths: 4' (1220 mm) standard / 54 (1370 mm) Lengths: 8' to 12' / (2440 mm to 3660 mm) Edges: Tapered Packaging: Two pieces per bundle, face-to-face and end-taped Special widths, lengths or edges may be available on special order. Consult your CertainTeed sales representative. Surface Burning Characteristics: CertainTeed Type X Gypsum Board has a Flame Spread rating of 15 and Smoke Developed rating of 0, in accordance with ASTM E 84, (UL 723, UBC 8-1, NFPA 255, CAN/ULC-S102). UL Classified for Fire Resistance (ANSI/UL 263; ASTM E119) and listed under UL File No. CKNX.R3660 Applicable Standards: meets ASTM C1396.",
      "product 2 spec"]
    },
    {
    ...
    techDetail: [
      "Easi-Lite Drywall is light weight, easy to handle and ideal for wall and ceiling applications up to 24' o.c. (610 mm) framing spacing. Product Data: Thicknesses: 1/2' (12.7 mm) Weight: 1.2 - 1.4 psf (5.9 - 6.8 kg/m2) Widths: 4' (1220 mm) standard 54' (1375 mm) Lengths: 8' (2440 mm) to 12' (3660 mm) Edges: Tapered Packaging: Two pieces per bundle, face-to-face and end-taped Applicable Standards: ASTM C 1396 and CAN/CSA-A82.27",
      "product 3 spec"]
    },
    {
    ...
    techDetail: [
      "Product Code RF403N Width 914 mm (36″) Length 43,8 m (144′) Coverage 40 m2 (432 ft2) Rolls per Pallet 25 Standards ASTM D-4869 Type I CSA A123.3 Type II",
      "product 6 spec"]
    }
  ],
